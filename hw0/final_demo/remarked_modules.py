...
def news_containing_keyword(keyword, news_list): # return the list of news that contains keyword
...
def news_containing_keywords(keywords, news_list): # return the list of news that contains all the keywords
    news = news_list
...
def get_cutted_dict(list_of_news): # return the word frequency dictionary
